...
class CadenaSupermercadosServiceTest {
    ...
    fun setUp() {
        ...
        val producto3 = Producto(3, "Pollo", 30.0)
        val producto4 = Producto(4, "Cerdo", 45.0)
        val producto5 = Producto(5, "Ternera", 50.0)
        val producto6 = Producto(6, "Cordero", 65.0)
        ...
        val supermercado1 = Supermercado(1, "Supermercado A1", 8, 20, listOf("Lunes", "Martes"))
        val supermercado2 = Supermercado(2, "Supermercado A2", 8, 20, listOf("Lunes", "Martes"))
        ...
        cadenaSupermercados = CadenaSupermercados(1, "Cadena A", supermercadosParaLaCadena)
        cadenaSupermercadosRepository.addCadenaSupermercados(cadenaSupermercados)

        posesionService.addPosesion(1, 1, 20) // 20 unidades de Carne en Supermercado A1
        posesionService.addPosesion(2, 1, 10) // 10 unidades de Pescado en Supermercado A1
        posesionService.addPosesion(1, 2, 15) // 15 unidades de Carne en Supermercado A2
        posesionService.addPosesion(3, 2, 25) // 25 unidades de Pollo en Supermercado A2
    }

    @Test
    fun getCincoProductosMasVendidosTest() {
        // Agregar stock y ventas para los 5 productos
        posesionService.addPosesion(3, 1, 15)
        posesionService.addPosesion(4, 1, 7)
        posesionService.addPosesion(5, 1, 12)
        posesionService.addPosesion(5, 2, 4)
        posesionService.addPosesion(6, 2, 5)

        ventaService.addVenta(1, 1, LocalDateTime.now(), 10)
        ventaService.addVenta(2, 1, LocalDateTime.now(), 5)
        ventaService.addVenta(3, 1, LocalDateTime.now(), 15)
        ventaService.addVenta(4, 1, LocalDateTime.now(), 7)
        ventaService.addVenta(5, 1, LocalDateTime.now(), 12)
        ventaService.addVenta(5, 2, LocalDateTime.now(), 4)
        ventaService.addVenta(6, 2, LocalDateTime.now(), 5)

        // Añadir ventas
        val top5MasVendidos = cadenaSupermercadosService.getCincoProductosMasVendidos(1)
    ...
    fun getCincoProductosMasVendidosTestConMenosDe5Productos() {
        ...
        ventaService.addVenta(1, 1, LocalDateTime.now(), 10)
        ventaService.addVenta(2, 1, LocalDateTime.now(), 9)
    ...
    fun getIngresosTotalesSupermercadosConVentasTest() {
        ...
        ventaService.addVenta(1, 1, LocalDateTime.now(), 10)
        ventaService.addVenta(2, 1, LocalDateTime.now(), 5)
        ventaService.addVenta(1, 2, LocalDateTime.now(), 7)
        ventaService.addVenta(3, 2, LocalDateTime.now(), 12)

        // Obtener ingresos totales para la cadena de supermercados
        val resultado = cadenaSupermercadosService.getIngresosTotalesSupermercados(1)
    ...
    fun getSupermercadoMayoresIngresosTest() {
        posesionService.addPosesion(2, 2, 10)

        // Agregar stock y ventas
        ventaService.addVenta(1, 1, LocalDateTime.now(), 10)
        ventaService.addVenta(1, 2, LocalDateTime.now(), 15)
        ventaService.addVenta(2, 2, LocalDateTime.now(), 5)

        val resultado = cadenaSupermercadosService.getSupermercadoMayoresIngresos(1)
        assertEquals("Supermercado A2 (2). Ingresos totales: 250.0", resultado)
    }
    ...
    fun getSupermercadoMayoresIngresosEmpateTest() {
        ...
        val resultado = cadenaSupermercadosService.getSupermercadoMayoresIngresos(1)
        assertEquals("Supermercado A1 (1). Ingresos totales: 100.0", resultado)
    }
    ...
    fun getSupermercadoMayoresIngresosTestSinVentas() {
        ...
        val resultado = cadenaSupermercadosService.getSupermercadoMayoresIngresos(1)
        assertEquals("No hay ventas registradas para la cadena de supermercados 1.", resultado)
    }
}
